...
import it.csi.gescovid.gestruttureresapi.business.be.RsaVisitatoriIngressiApi;
import it.csi.gescovid.gestruttureresapi.business.be.impl.mapper.dto.RsaVisitatoriIngressi;
import it.csi.gescovid.gestruttureresapi.business.be.impl.mapper.extended.RsaVisitatoriIngressiMapper;
...
public class RsaVisitatoriIngressiApiServiceImpl extends RESTBaseService implements RsaVisitatoriIngressiApi {

	@Autowired
	private RsaVisitatoriIngressiMapper rsaVisitatoriIngressiMapper;

	@Override
	public Response getVisitatoriIngressi(String shibIdentitaCodiceFiscale, String xApplicazioneCodice,
			String xRequestId, String xForwardedFor, String userAgent, SecurityContext securityContext,
			HttpHeaders httpHeaders, HttpServletRequest httpRequest) {
		String methodName = "getVisitatoriIngressi";
		...
		try {
			...
			List<RsaVisitatoriIngressi> list = rsaVisitatoriIngressiMapper.selectAllValid();
			logAudit(httpHeaders, "select", "covidrsa_d_visitatori_ingressi", methodName);
