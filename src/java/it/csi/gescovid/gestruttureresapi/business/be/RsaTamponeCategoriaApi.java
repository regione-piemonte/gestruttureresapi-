...
@Path("/rsa-tampone-categoria")
@Api(value = "RsaTamponeCategoria", produces = MediaType.APPLICATION_JSON)
@ApiResponsesDefault
public interface RsaTamponeCategoriaApi {
	
	@GET
	@Produces({ "application/json" })
	@ApiResponses(value = { 
			@ApiResponse(code = 200, message = "Success", response = RsaTamponeCategoria.class)
	})
	public Response getTamponeCategorie(
