...
@Path("/struttura-categoria")
@Api(value = "StrutturaCategoria", produces = MediaType.APPLICATION_JSON)
@ApiResponsesDefault
public interface StrutturaCategoriaApi {
	
	@GET
    @Produces({ "application/json" })
    @ApiResponses(value = { 
    		@ApiResponse(code = 200, message = "Success", response = StrutturaCategoriaApi.class, responseContainer = "List")
    })
    public Response getStrutturaCategoria(
