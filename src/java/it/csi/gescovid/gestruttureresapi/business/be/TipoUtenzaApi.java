...
@Path("/tipo-utenza")
@Api(value = "tipoUtenza", produces = MediaType.APPLICATION_JSON)
@ApiResponsesDefault
public interface TipoUtenzaApi {

	@GET
	@Produces({ "application/json" })
	@ApiResponses(value = { 
			@ApiResponse(code = 200, message = "Success", response = TipoUtenzaApi.class, responseContainer = "List")
	})
	public Response getTipiUtenze(
