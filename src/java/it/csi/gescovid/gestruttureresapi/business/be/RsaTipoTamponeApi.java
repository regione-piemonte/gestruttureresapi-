...
@Path("/rsa-tipo-tampone")
@Api(value = "RsaTipoTampone", produces = MediaType.APPLICATION_JSON)
@ApiResponsesDefault
public interface RsaTipoTamponeApi {
	
	@GET
	@Produces({ "application/json" })
	@ApiResponses(value = { 
			@ApiResponse(code = 200, message = "Success", response = RsaTipoTampone.class)
	})
	public Response getTipiTampone(
