...
@Path("/rsa-personale-tipo")
@Api(value = "RsaPersonaleTipo", produces = MediaType.APPLICATION_JSON)
@ApiResponsesDefault
public interface RsaPersonaleTipoApi {
	
	@GET
	@Produces({ "application/json" })
	@ApiResponses(value = { 
			@ApiResponse(code = 200, message = "Success", response = RsaPersonaleTipo.class)
	})
	public Response getPersonaleTipo(
