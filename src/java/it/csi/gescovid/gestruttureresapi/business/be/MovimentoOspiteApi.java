...
@Path("/movimento-ospite")
@Api(value = "MovimentoOspite", produces = MediaType.APPLICATION_JSON)
@ApiResponsesDefault
public interface MovimentoOspiteApi {
	
	@GET
    @Produces({ "application/json" })
    @Path("/{idSoggetto}")
    @ApiResponses(value = { 
    		@ApiResponse(code = 200, message = "Success", response = CovidrsaTMovimentoOspiteExt.class)
    })
    public Response getMovimentoOspite(
            ...
            @PathParam("idSoggetto") Integer idSoggetto,       
    ...
    @POST
        ...
        @io.swagger.annotations.ApiOperation(value = "post movimento ospite", notes = "inserimento struttura conto")
        public Response postMovimentoOspite(
                @ApiParam(required = true) @HeaderParam("Shib-Identita-CodiceFiscale") String shibIdentitaCodiceFiscale,
                @ApiParam(required = true) @HeaderParam("X-Applicazione-Codice") String xApplicazioneCodice,
                @ApiParam(required = true) @HeaderParam("X-Request-Id") String xRequestId,
                @ApiParam(required = true) @HeaderParam("X-Forwarded-For") String xForwardedFor,
    ...
    @Path("/delete")
        ...
        @io.swagger.annotations.ApiOperation(value = "post movimento ospite", notes = "inserimento struttura conto")
        public Response deleteMovimentoOspite(
                @ApiParam(required = true) @HeaderParam("Shib-Identita-CodiceFiscale") String shibIdentitaCodiceFiscale,
                @ApiParam(required = true) @HeaderParam("X-Applicazione-Codice") String xApplicazioneCodice,
                @ApiParam(required = true) @HeaderParam("X-Request-Id") String xRequestId,
                @ApiParam(required = true) @HeaderParam("X-Forwarded-For") String xForwardedFor,
