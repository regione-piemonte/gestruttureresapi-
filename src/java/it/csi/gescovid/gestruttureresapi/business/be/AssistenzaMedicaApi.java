...
@Path("/assistenza-medica")
@Api(value = "AssistenzaMedica", produces = MediaType.APPLICATION_JSON)
@ApiResponsesDefault
public interface AssistenzaMedicaApi {
	
	@GET
	@Produces({ "application/json" })
	@ApiResponses(value = { 
			@ApiResponse(code = 200, message = "Success", response = AssistenzaMedica.class, responseContainer = "List")
	})
	public Response getAssistenzaMedica(
