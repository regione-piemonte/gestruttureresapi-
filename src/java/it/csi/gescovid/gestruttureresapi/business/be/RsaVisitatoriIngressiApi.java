...
@Path("/rsa-visitatori-ingressi")
@Api(value = "RsaVisitatoriIngressi", produces = MediaType.APPLICATION_JSON)
@ApiResponsesDefault
public interface RsaVisitatoriIngressiApi {
	
	@GET
	@Produces({ "application/json" })
	@ApiResponses(value = { 
			@ApiResponse(code = 200, message = "Success", response = RsaVisitatoriIngressi.class)
	})
	public Response getVisitatoriIngressi(
