...
@Path("/struttura-conto")
@Api(value = "StrutturaCategoria", produces = MediaType.APPLICATION_JSON)
@ApiResponsesDefault
public interface StrutturaContoApi {
	
	@GET
    @Produces({ "application/json" })
    @ApiResponses(value = { 
    		@ApiResponse(code = 200, message = "Success", response = CovidrsaRStrutturaContoExt.class, responseContainer = "List")
    })
    public Response getStrutturaConto(
    ...
    @POST
        ...
        @io.swagger.annotations.ApiOperation(value = "post struttura conto", notes = "inserimento struttura conto")
        public Response postStrutturaConto(
                @ApiParam(required = true) @HeaderParam("Shib-Identita-CodiceFiscale") String shibIdentitaCodiceFiscale,
                @ApiParam(required = true) @HeaderParam("X-Applicazione-Codice") String xApplicazioneCodice,
                @ApiParam(required = true) @HeaderParam("X-Request-Id") String xRequestId,
                @ApiParam(required = true) @HeaderParam("X-Forwarded-For") String xForwardedFor,
                ...
                CovidrsaRStrutturaContoExt payload,
                @Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
    ...
    @io.swagger.annotations.ApiOperation(value = "delete logica struttura conto", notes = "cancelliamo struttura conto")
    public Response invalidaStrutturaConto(
            @ApiParam(required = true) @HeaderParam("Shib-Identita-CodiceFiscale") String shibIdentitaCodiceFiscale,
            @ApiParam(required = true) @HeaderParam("X-Applicazione-Codice") String xApplicazioneCodice,
            @ApiParam(required = true) @HeaderParam("X-Request-Id") String xRequestId,
            @ApiParam(required = true) @HeaderParam("X-Forwarded-For") String xForwardedFor,
            ...
            CovidrsaRStrutturaConto payload,
            @Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
