...
import it.csi.gescovid.gestruttureresapi.business.be.RsaTamponeCategoriaApi;
import it.csi.gescovid.gestruttureresapi.business.be.impl.mapper.dto.RsaTamponeCategoria;
import it.csi.gescovid.gestruttureresapi.business.be.impl.mapper.extended.RsaTamponeCategoriaMapper;
...
public class RsaTamponeCategoriaApiServiceImpl extends RESTBaseService implements RsaTamponeCategoriaApi{

	@Autowired
	private RsaTamponeCategoriaMapper rsaTamponeCategoriaMapper;
	
	@Override
	public Response getTamponeCategorie(String shibIdentitaCodiceFiscale, String xApplicazioneCodice, String xRequestId,
			String xForwardedFor, String userAgent, SecurityContext securityContext, HttpHeaders httpHeaders,
			HttpServletRequest httpRequest) {
		String methodName = "getTamponeCategorie";
		...
		try {
			...
			List<RsaTamponeCategoria> list = rsaTamponeCategoriaMapper.selectAllValid();
			logAudit(httpHeaders, "select", "covidrsa_d_tampone_categoria", methodName);
